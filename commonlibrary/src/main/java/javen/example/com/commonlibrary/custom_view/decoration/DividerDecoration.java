package javen.example.com.commonlibrary.custom_view.decoration;
...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerDecoration(Context context, int dividerBottomMargin, int dividerRightMargin, int type) {
        ...
        if (CommonLibraryApplication.getContext().getTheme().resolveAttribute(android.R.attr.listDivider, typedValue, true) && typedValue.data != 0) {
            this.divider = CommonLibraryApplication.getContext().getResources().getDrawable(typedValue.resourceId,context.getTheme());
        }
    }
