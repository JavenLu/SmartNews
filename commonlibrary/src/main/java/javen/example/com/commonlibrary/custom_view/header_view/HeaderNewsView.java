package javen.example.com.commonlibrary.custom_view.header_view;
...
public class HeaderNewsView extends Base {
    ...
    public HeaderNewsView(Context context) {
        super(context);
    }

    public HeaderNewsView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HeaderNewsView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mPaint.setColor(Color.WHITE);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //getHeight() 获取的是这个view最终显示的大小，这个大小有可能等于原始的大小也有可能不等于原始大小。
